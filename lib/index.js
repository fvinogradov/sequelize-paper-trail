...
var ns = cls.getNamespace('com.churchdesk');
...
exports.default = function (sequelize, optionsArg) {
	...
	var afterHook = function afterHook(instance, opt) {
		...
		if (instance.context && instance.context.delta && instance.context.delta.length > 0) {
			...
			if(options.userModel) {
				revision.userId = ns.get(options.continuationKey);
			}
